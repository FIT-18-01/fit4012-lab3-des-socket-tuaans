...
## Team members
- **Thành viên 1**: Student 1 - MSSV: 123456
- **Thành viên 2**: Student 2 - MSSV: 654321

## Task division
- **Thành viên 1 phụ trách chính**: Sender and encryption
- **Thành viên 2 phụ trách chính**: Receiver and decryption
- **Phần làm chung**: Tests, logs, reports

## Demo roles
- **Bạn nào demo Sender / gói tin / log gửi**: Student 1
- **Bạn nào demo Receiver / giải mã / log nhận**: Student 2
- **Cả hai cùng trả lời threat model và ethics**: Both
